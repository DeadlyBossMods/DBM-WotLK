...
local warnInstability			= mod:NewStackAnnounce(69766, 2, nil, false)
local warnChilledtotheBone		= mod:NewStackAnnounce(70106, 2, nil, false)
local warnMysticBuffet			= mod:NewStackAnnounce(70128, 2, nil, false)
